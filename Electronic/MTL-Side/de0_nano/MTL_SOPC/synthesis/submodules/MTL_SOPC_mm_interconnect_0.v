...
module MTL_SOPC_mm_interconnect_0 (
		...
		input  wire        TESTLED_reset_reset_bridge_in_reset_reset,     //     TESTLED_reset_reset_bridge_in_reset.reset
	...
	wire  [75:0] maptransfer_avalon_slave_agent_rf_source_data;                             // mapTransfer_avalon_slave_agent:rf_source_data -> mapTransfer_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [75:0] maptransfer_avalon_slave_agent_rsp_fifo_out_data;                          // mapTransfer_avalon_slave_agent_rsp_fifo:out_data -> mapTransfer_avalon_slave_agent:rf_sink_data
	...
	wire   [7:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> CPU_jtag_debug_module_agent:cp_channel
	...
	wire   [7:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> KEY_s1_agent:cp_channel
	...
	wire  [93:0] testled_s1_agent_rf_source_data;                                           // TESTLED_s1_agent:rf_source_data -> TESTLED_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] testled_s1_agent_rsp_fifo_out_data;                                        // TESTLED_s1_agent_rsp_fifo:out_data -> TESTLED_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> TESTLED_s1_agent:cp_valid
	wire  [92:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> TESTLED_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // TESTLED_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> TESTLED_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> TESTLED_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> TESTLED_s1_agent:cp_endofpacket
	...
	wire  [93:0] mem_s1_agent_rf_source_data;                                               // mem_s1_agent:rf_source_data -> mem_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] mem_s1_agent_rsp_fifo_out_data;                                            // mem_s1_agent_rsp_fifo:out_data -> mem_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> mem_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // mem_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> mem_s1_agent:cp_channel
	...
	wire  [93:0] touchdata_s1_agent_rf_source_data;                                         // TOUCHDATA_s1_agent:rf_source_data -> TOUCHDATA_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] touchdata_s1_agent_rsp_fifo_out_data;                                      // TOUCHDATA_s1_agent_rsp_fifo:out_data -> TOUCHDATA_s1_agent:rf_sink_data
	...
	wire         cmd_mux_007_src_valid;                                                     // cmd_mux_007:src_valid -> TOUCHDATA_s1_agent:cp_valid
	wire  [92:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> TOUCHDATA_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                     // TOUCHDATA_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> TOUCHDATA_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                             // cmd_mux_007:src_startofpacket -> TOUCHDATA_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                               // cmd_mux_007:src_endofpacket -> TOUCHDATA_s1_agent:cp_endofpacket
	...
	wire  [74:0] maptransfer_avalon_slave_agent_rp_data;                                    // mapTransfer_avalon_slave_agent:rp_data -> router_003:sink_data
	...
	wire         testled_s1_agent_rp_valid;                                                 // TESTLED_s1_agent:rp_valid -> router_007:sink_valid
	wire  [92:0] testled_s1_agent_rp_data;                                                  // TESTLED_s1_agent:rp_data -> router_007:sink_data
	wire         testled_s1_agent_rp_ready;                                                 // router_007:sink_ready -> TESTLED_s1_agent:rp_ready
	wire         testled_s1_agent_rp_startofpacket;                                         // TESTLED_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         testled_s1_agent_rp_endofpacket;                                           // TESTLED_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [92:0] mem_s1_agent_rp_data;                                                      // mem_s1_agent:rp_data -> router_008:sink_data
	...
	wire         touchdata_s1_agent_rp_valid;                                               // TOUCHDATA_s1_agent:rp_valid -> router_009:sink_valid
	wire  [92:0] touchdata_s1_agent_rp_data;                                                // TOUCHDATA_s1_agent:rp_data -> router_009:sink_data
	wire         touchdata_s1_agent_rp_ready;                                               // router_009:sink_ready -> TOUCHDATA_s1_agent:rp_ready
	wire         touchdata_s1_agent_rp_startofpacket;                                       // TOUCHDATA_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         touchdata_s1_agent_rp_endofpacket;                                         // TOUCHDATA_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [74:0] maptransfer_avalon_slave_burst_adapter_source0_data;                       // mapTransfer_avalon_slave_burst_adapter:source0_data -> mapTransfer_avalon_slave_agent:cp_data
	...
	wire   [7:0] maptransfer_avalon_slave_burst_adapter_source0_channel;                    // mapTransfer_avalon_slave_burst_adapter:source0_channel -> mapTransfer_avalon_slave_agent:cp_channel
	...
	wire  [74:0] router_003_src_data;                                                       // router_003:src_data -> mapTransfer_avalon_slave_rsp_width_adapter:in_data
	wire         router_003_src_ready;                                                      // mapTransfer_avalon_slave_rsp_width_adapter:in_ready -> router_003:src_ready
	wire   [7:0] router_003_src_channel;                                                    // router_003:src_channel -> mapTransfer_avalon_slave_rsp_width_adapter:in_channel
	...
	wire  [92:0] maptransfer_avalon_slave_rsp_width_adapter_src_data;                       // mapTransfer_avalon_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire   [7:0] maptransfer_avalon_slave_rsp_width_adapter_src_channel;                    // mapTransfer_avalon_slave_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire  [92:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> mapTransfer_avalon_slave_cmd_width_adapter:in_data
	wire         cmd_mux_001_src_ready;                                                     // mapTransfer_avalon_slave_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire   [7:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> mapTransfer_avalon_slave_cmd_width_adapter:in_channel
	...
	wire  [74:0] maptransfer_avalon_slave_cmd_width_adapter_src_data;                       // mapTransfer_avalon_slave_cmd_width_adapter:out_data -> mapTransfer_avalon_slave_burst_adapter:sink0_data
	...
	wire   [7:0] maptransfer_avalon_slave_cmd_width_adapter_src_channel;                    // mapTransfer_avalon_slave_cmd_width_adapter:out_channel -> mapTransfer_avalon_slave_burst_adapter:sink0_channel
	...
	wire         testled_s1_agent_rdata_fifo_src_valid;                                     // TESTLED_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] testled_s1_agent_rdata_fifo_src_data;                                      // TESTLED_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         testled_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_005:in_0_ready -> TESTLED_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                         // avalon_st_adapter_005:out_0_valid -> TESTLED_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                          // avalon_st_adapter_005:out_0_data -> TESTLED_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                         // TESTLED_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                         // avalon_st_adapter_005:out_0_error -> TESTLED_s1_agent:rdata_fifo_sink_error
	...
	wire         touchdata_s1_agent_rdata_fifo_src_valid;                                   // TOUCHDATA_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] touchdata_s1_agent_rdata_fifo_src_data;                                    // TOUCHDATA_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         touchdata_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_007:in_0_ready -> TOUCHDATA_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                         // avalon_st_adapter_007:out_0_valid -> TOUCHDATA_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                          // avalon_st_adapter_007:out_0_data -> TOUCHDATA_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                         // TOUCHDATA_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                         // avalon_st_adapter_007:out_0_error -> TOUCHDATA_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (CLK_50_clk_clk),                                  //                      clk.clk
		.reset                  (TESTLED_reset_reset_bridge_in_reset_reset),       //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (CLK_50_clk_clk),                                               //             clk.clk
		.reset                   (TESTLED_reset_reset_bridge_in_reset_reset),                    //       clk_reset.reset
	...
	MTL_SOPC_mm_interconnect_0_router_004 router_004 (
	...
	MTL_SOPC_mm_interconnect_0_router_004 router_008 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (TESTLED_reset_reset_bridge_in_reset_reset),                    // cr0_reset.reset
	...
	MTL_SOPC_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (CLK_50_clk_clk),                          //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MTL_SOPC_mm_interconnect_0_cmd_mux_002 cmd_mux_006 (
		.clk                 (CLK_50_clk_clk),                            //       clk.clk
		.reset               (TESTLED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MTL_SOPC_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (CLK_50_clk_clk),                          //       clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MTL_SOPC_mm_interconnect_0_rsp_demux_002 rsp_demux_006 (
		.clk                (CLK_50_clk_clk),                            //       clk.clk
		.reset              (TESTLED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MTL_SOPC_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (CLK_50_clk_clk),                                      // in_clk_0.clk
		.in_rst_0_reset (TESTLED_reset_reset_bridge_in_reset_reset),           // in_rst_0.reset
