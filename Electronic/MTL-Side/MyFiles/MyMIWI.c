        ...
        switch(MODE){
            ...
            case myMIWI_LTDemo:
                ...
                if(received_tag +1 == theData[1]){
                    ...
                    if(pimage->color_r != lastimage.color_r || pimage->color_g != lastimage.color_g || pimage->color_b != lastimage.color_b  ) // if img changes
                    {
                        ...
                        lastimage.color_r = pimage->color_r;
                        lastimage.color_g = pimage->color_g; 
                        lastimage.color_b = pimage->color_b;
                    }
