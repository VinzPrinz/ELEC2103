...
module DE0_LT24_SOPC_mm_interconnect_0 (
		...
		output wire [10:0] pic_mem_s1_address,                                        //                                          pic_mem_s1.address
	...
	wire  [105:0] cyclonespi_avs_s0_agent_rf_source_data;                                    // cycloneSPI_avs_s0_agent:rf_source_data -> cycloneSPI_avs_s0_agent_rsp_fifo:in_data
	...
	wire  [105:0] cyclonespi_avs_s0_agent_rsp_fifo_out_data;                                 // cycloneSPI_avs_s0_agent_rsp_fifo:out_data -> cycloneSPI_avs_s0_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> cycloneSPI_avs_s0_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                     // cycloneSPI_avs_s0_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [15:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> cycloneSPI_avs_s0_agent:cp_channel
	...
	wire  [104:0] cyclonespi_avs_s0_agent_rp_data;                                           // cycloneSPI_avs_s0_agent:rp_data -> router_005:sink_data
