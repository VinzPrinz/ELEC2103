	DE0_LT24_SOPC u0 (
		...
		.cyclonespi_spi_interface_SPI_clk             (<connected-to-cyclonespi_spi_interface_SPI_clk>),             //             cyclonespi_spi_interface.SPI_clk
		.cyclonespi_spi_interface_SPI_CS              (<connected-to-cyclonespi_spi_interface_SPI_CS>),              //                                     .SPI_CS
		.cyclonespi_spi_interface_SPI_SDI             (<connected-to-cyclonespi_spi_interface_SPI_SDI>),             //                                     .SPI_SDI
		.cyclonespi_spi_interface_SPI_SDO             (<connected-to-cyclonespi_spi_interface_SPI_SDO>),             //                                     .SPI_SDO
		.cyclonespi_spi_interface_data_out            (<connected-to-cyclonespi_spi_interface_data_out>),            //                                     .data_out
		.cyclonespi_spi_interface_data_out_enable     (<connected-to-cyclonespi_spi_interface_data_out_enable>),     //                                     .data_out_enable
		...
		.lt24_interface_irq_0_conduit_end_finish_flag (<connected-to-lt24_interface_irq_0_conduit_end_finish_flag>), //     lt24_interface_irq_0_conduit_end.finish_flag
		.lt24_interface_irq_0_conduit_end_counter     (<connected-to-lt24_interface_irq_0_conduit_end_counter>),     //                                     .counter
		.lt24_interface_irq_0_conduit_end_pattern     (<connected-to-lt24_interface_irq_0_conduit_end_pattern>),     //                                     .pattern
