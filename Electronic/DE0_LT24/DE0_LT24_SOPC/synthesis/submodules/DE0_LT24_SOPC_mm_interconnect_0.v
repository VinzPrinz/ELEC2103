...
module DE0_LT24_SOPC_mm_interconnect_0 (
	...
	wire   [18:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> LT24_CTRL_avalon_slave_0_agent:cp_channel
	...
	wire   [18:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> LED_CTRL_avalon_slave_0_agent:cp_channel
	...
	wire   [18:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> cycloneSPI_avs_s0_agent:cp_channel
	...
	wire   [18:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> LT24_interface_irq_0_avs_s0_agent:cp_channel
	...
	wire   [18:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> CPU_jtag_debug_module_agent:cp_channel
	...
	wire   [18:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> ALT_PLL_pll_slave_agent:cp_channel
	...
	wire   [18:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> KEY_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> TIMER_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> LT24_LCD_RSTN_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> LT24_TOUCH_PENIRQ_N_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_012_src_channel;                                                   // cmd_mux_012:src_channel -> LT24_TOUCH_BUSY_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_014_src_channel;                                                   // cmd_mux_014:src_channel -> LT24_buffer_flag_s1_agent:cp_channel
	...
	wire   [18:0] cmd_mux_016_src_channel;                                                   // cmd_mux_016:src_channel -> gsensor_int_s1_agent:cp_channel
	...
	wire   [18:0] cmd_demux_001_src0_channel;                                                // cmd_demux_001:src0_channel -> cmd_mux_005:sink1_channel
	...
	wire   [18:0] cmd_demux_001_src1_channel;                                                // cmd_demux_001:src1_channel -> cmd_mux_007:sink1_channel
	...
	wire   [18:0] rsp_demux_005_src1_channel;                                                // rsp_demux_005:src1_channel -> rsp_mux_001:sink0_channel
	...
	wire   [18:0] rsp_demux_007_src1_channel;                                                // rsp_demux_007:src1_channel -> rsp_mux_001:sink1_channel
	...
	wire   [18:0] router_009_src_channel;                                                    // router_009:src_channel -> SDRAM_s1_rsp_width_adapter:in_channel
	...
	wire   [18:0] sdram_s1_rsp_width_adapter_src_channel;                                    // SDRAM_s1_rsp_width_adapter:out_channel -> rsp_demux_007:sink_channel
	...
	wire   [18:0] router_015_src_channel;                                                    // router_015:src_channel -> pic_mem_s1_rsp_width_adapter:in_channel
	...
	wire   [18:0] pic_mem_s1_rsp_width_adapter_src_channel;                                  // pic_mem_s1_rsp_width_adapter:out_channel -> rsp_demux_013:sink_channel
	...
	wire   [18:0] router_017_src_channel;                                                    // router_017:src_channel -> background_mem_s1_rsp_width_adapter:in_channel
	...
	wire   [18:0] background_mem_s1_rsp_width_adapter_src_channel;                           // background_mem_s1_rsp_width_adapter:out_channel -> rsp_demux_015:sink_channel
	...
	wire   [18:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> SDRAM_s1_cmd_width_adapter:in_channel
	...
	wire   [18:0] cmd_mux_013_src_channel;                                                   // cmd_mux_013:src_channel -> pic_mem_s1_cmd_width_adapter:in_channel
	...
	wire   [18:0] cmd_mux_015_src_channel;                                                   // cmd_mux_015:src_channel -> background_mem_s1_cmd_width_adapter:in_channel
	...
	wire   [18:0] cmd_demux_src6_channel;                                                    // cmd_demux:src6_channel -> crosser_003:in_channel
	...
	wire   [18:0] crosser_003_out_channel;                                                   // crosser_003:out_channel -> cmd_mux_006:sink0_channel
	...
	wire   [18:0] cmd_demux_src9_channel;                                                    // cmd_demux:src9_channel -> crosser_005:in_channel
	...
	wire   [18:0] crosser_005_out_channel;                                                   // crosser_005:out_channel -> cmd_mux_009:sink0_channel
	...
	wire  [106:0] rsp_demux_002_src0_data;                                                   // rsp_demux_002:src0_data -> crosser_011:in_data
	wire          rsp_demux_002_src0_ready;                                                  // crosser_011:in_ready -> rsp_demux_002:src0_ready
	wire   [18:0] rsp_demux_002_src0_channel;                                                // rsp_demux_002:src0_channel -> crosser_011:in_channel
	...
	wire  [106:0] crosser_011_out_data;                                                      // crosser_011:out_data -> rsp_mux:sink2_data
	wire          crosser_011_out_ready;                                                     // rsp_mux:sink2_ready -> crosser_011:out_ready
	wire   [18:0] crosser_011_out_channel;                                                   // crosser_011:out_channel -> rsp_mux:sink2_channel
	...
	wire  [106:0] rsp_demux_004_src0_data;                                                   // rsp_demux_004:src0_data -> crosser_013:in_data
	wire          rsp_demux_004_src0_ready;                                                  // crosser_013:in_ready -> rsp_demux_004:src0_ready
	wire   [18:0] rsp_demux_004_src0_channel;                                                // rsp_demux_004:src0_channel -> crosser_013:in_channel
	...
	wire  [106:0] crosser_013_out_data;                                                      // crosser_013:out_data -> rsp_mux:sink4_data
	wire          crosser_013_out_ready;                                                     // rsp_mux:sink4_ready -> crosser_013:out_ready
	wire   [18:0] crosser_013_out_channel;                                                   // crosser_013:out_channel -> rsp_mux:sink4_channel
	...
	wire  [106:0] rsp_demux_006_src0_data;                                                   // rsp_demux_006:src0_data -> crosser_014:in_data
	wire          rsp_demux_006_src0_ready;                                                  // crosser_014:in_ready -> rsp_demux_006:src0_ready
	wire   [18:0] rsp_demux_006_src0_channel;                                                // rsp_demux_006:src0_channel -> crosser_014:in_channel
	...
	wire  [106:0] crosser_014_out_data;                                                      // crosser_014:out_data -> rsp_mux:sink6_data
	wire          crosser_014_out_ready;                                                     // rsp_mux:sink6_ready -> crosser_014:out_ready
	wire   [18:0] crosser_014_out_channel;                                                   // crosser_014:out_channel -> rsp_mux:sink6_channel
	...
	wire  [106:0] rsp_demux_009_src0_data;                                                   // rsp_demux_009:src0_data -> crosser_016:in_data
	wire          rsp_demux_009_src0_ready;                                                  // crosser_016:in_ready -> rsp_demux_009:src0_ready
	wire   [18:0] rsp_demux_009_src0_channel;                                                // rsp_demux_009:src0_channel -> crosser_016:in_channel
	...
	wire  [106:0] crosser_016_out_data;                                                      // crosser_016:out_data -> rsp_mux:sink9_data
	wire          crosser_016_out_ready;                                                     // rsp_mux:sink9_ready -> crosser_016:out_ready
	wire   [18:0] crosser_016_out_channel;                                                   // crosser_016:out_channel -> rsp_mux:sink9_channel
